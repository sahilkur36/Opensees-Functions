function [ ] = main_write_tcl( model_dimension, write_dir, node, element, story, joint, hinge, analysis, read_dir_analysis, ground_motion, model, ele_props_table )
...
%% Build Scripts
[ joint_ele_ids ] = fn_define_model( write_dir, node, element, joint, hinge, analysis, model_dimension, story, read_dir_analysis, model, ele_props_table );

% Define recorderes and loading conditions
fn_define_recorders( write_dir, model_dimension, node, element, joint, hinge, analysis );
[ model ] = fn_define_loads( write_dir, analysis, node, model_dimension, story, element, joint, ground_motion, model);
